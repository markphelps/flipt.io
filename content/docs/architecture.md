...
{{< figure src="/img/architecture.svg" alt="Flipt Architecture" >}}
...
A guide to using the UI for the first time can be found in the [Getting Started]({{< relref "/docs/getting_started" >}}) documentation.
